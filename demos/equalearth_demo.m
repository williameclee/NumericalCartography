...
%   2024-08-14, En-Chi Lee (williameclee@gmail.com)
...
function equalearth_demo(varargin)
    ...
    %% Projection
    coastXY = equalearthd(coastLonlat, lonOrigin);
    bboxXY = equalearthd(bbox, lonOrigin, "Anchors", true);
    circlesXY = equalearthd(circlesLonlat, lonOrigin);
